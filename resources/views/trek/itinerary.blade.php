    ...
    <div class="content-container">
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="day-card">
                ...
                <div class="day-body">
                    <p>Arrive in Pokhara. Transfer to hotel near Lakeside. Relax, explore the lake, and prepare gear. Evening briefing with guide.</p>
            ...
            <div class="day-card">
                ...
                <div class="day-body">
                    <p>Short drive to Nayapul. Start trek along Modi River to Tikhedhunga. Enjoy waterfalls and green hills.</p>
            ...
            <div class="day-card">
                ...
                <div class="day-body">
                    <p>Steep climb through rhododendron forest to Ulleri, then gradual ascent to Ghorepani. Famous for Poon Hill sunrise next day.</p>
            ...
            <div class="day-card">
                ...
                <div class="day-body">
                    <p>Early morning hike to Poon Hill (3,210 m) for epic sunrise over Annapurna & Dhaulagiri. Trek to Tadapani.</p>
        ...
        <!-- Final CTA -->
        <div class="text-center py-20 bg-gradient-to-r from-teal-600 to-cyan-600 text-white">
            <h2 class="text-4xl font-bold mb-6">Ready for Your Himalayan Adventure?</h2>
            <a href="{{ route('trek.booking') }}"
               class="inline-block bg-white text-teal-700 font-bold text-xl px-16 py-5 rounded-full shadow-2xl hover:bg-gray-100 transform hover:scale-105 transition">
